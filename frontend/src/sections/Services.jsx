    ...
    <div className="max-w-[1400px] mx-auto px-6 sm:px-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
        <Reveal className="max-w-2xl">
          <div className="overline mb-5">Portfolio of Services</div>
        ...
        <Reveal delay={0.15}>
          <p className="max-w-sm text-[#4a4a4a] font-light">
          ...
          <Reveal key={s.title} delay={i * 0.12}>
            ...
            >
              <div
                ...
                className="group relative h-[460px] rounded-2xl overflow-hidden border border-[#e6e3da] bg-white"
              >
